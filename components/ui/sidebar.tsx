...
import { BarChart3, Bell, Building2, FileText, Home, Shield, Users, LogOut } from "lucide-react"
    ...
    <Sidebar>
      <SidebarHeader>
        <div className="flex items-center gap-2 px-2">
          ...
          <span className="font-bold text-lg">ThreatShield</span>
        </div>
      </SidebarHeader>
      ...
      <SidebarContent>
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              isActive={pathname?.startsWith("/dashboard/organizations")}
